...
// devicesState.pickedSelector = null as SelectorInterface;
// devicesState.pickedController = null as ControllerInterface;
//
// /**
//  * Initialize devices
//  *
...
//  * @returns {DeviceInterface} - The picked device
//  */
// devicesState.pickDevice = function(name: string, devices: any): DeviceInterface {
