...
// import {DeviceInterface, DeviceSettingsInterface} from './device.types';
//
// export const devicePrototype = Object.create(null);
//
// devicePrototype.isInitialized = false as boolean;
// devicePrototype.device = null as DeviceInterface;
// devicePrototype.settings = null as DeviceSettingsInterface;
...
//   this.device = null as DeviceInterface;
//   this.settings = null as DeviceSettingsInterface;
...
// };
//
// export interface BlinkNoteOptions {
//   note: number;
//   color: number;
//   interval: number;
// }
...
// };
//
// export interface PlayOrBlinkNoteOptions {
//   note: number;
//   color: number;
//   interval: number;
//   duration: number;
...
// };
//
// export interface AddNoteListenerNewOptions {
//   note: number;
//   color: number;
...
// };
//
// export interface AddControlListenerNewOptions {
//   note: number;
//   callback;
//   isToggle: boolean;
// }
